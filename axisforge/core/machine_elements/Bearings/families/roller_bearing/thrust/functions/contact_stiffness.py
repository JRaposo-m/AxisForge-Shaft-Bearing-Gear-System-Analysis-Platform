"""
core/machine_elements/Bearings/families/roller/thrust/functions/contact_stiffness.py
...
lives in ../subtypes/ (thrust_cylindrical_roller.py, thrust_needle_roller.py).

Byte-identical to ../../radial/functions/contact_stiffness.py, duplicated
for the same reason as the ball side: duty-agnostic math (gamma() already
handles alpha_0=90deg), each duty folder self-contained.
"""
