...
from machine_elements.Gears.Parallel_Axis_gears.spur_gear import SpurGear
...
class SpurGearMeshing:
    ...
    def forces(self, T1: float) -> dict[str, float]:
        ...
        return {"Ft": Ft, "Fr": Fr, "Fn": Fn, "T2": T2}
