...
/ BallBearingStiffness to derive a further quantity -- contact force
distribution, ball positions, secant stiffness, dynamic equivalent load --
lives in ball_bearing_postprocessing.py instead. That file imports from this
...
class ISO16281BallSolver:
    ...
    already-computed LoadDistributionResult rather than producing one) live
    in ball_bearing_postprocessing.py as free functions. Capacity (Q_ci/Q_ce,
