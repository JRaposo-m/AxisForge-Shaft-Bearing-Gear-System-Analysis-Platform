...
if TYPE_CHECKING:
    ...
    from axisforge.solvers.machine_elements.bearings.ISO_16281.Ball_Bearing.ball_bearing import (
        RollingElementCapacity as BallRollingElementCapacity,
    )
...
class BearingResultBundle:
    ...
    capacity                 BallRollingElementCapacity | RollerElementCapacity | None
    ...
    capacity: "BallRollingElementCapacity | RollerElementCapacity | None" = None
