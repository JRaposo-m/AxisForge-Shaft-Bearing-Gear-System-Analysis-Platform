# stages/stage_2/gear_pair_1.py
# demo_reducer_2stages — stage_2 — Par de engrenagens 1
# Gerado automaticamente por AxisForge ProjectManager
#
# Preencher: parâmetros geométricos e torque de entrada
# Executar via full_pipeline.py → _run("stages/stage_2/gear_pair_1.py")
#
...
geo_stage_2 = gs.compute_geometry(
...
print(f"Gear pair 1: u={geo_stage_2.u:.4f}  "
      f"al={geo_stage_2.al:.3f}mm  "
      f"Ft={forces_stage_2.Ft:.1f}N  Fr={forces_stage_2.Fr:.1f}N")
